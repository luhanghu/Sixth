# Title：Dify System has an SSRF vulnerability 

## 1.summary

- Title：dify System has an SSRF vulnerability

- Vendor：https://github.com/langgenius/dify
...
+ Step 1: After creating an account and logging in, click to create a blank application.

  ![1](1.png)

+ Step 2: Select "Workflow" and click "Create".

  ![2](2.png)

+ Step 3: Click "Add Node" and select "HTTP Request".

  ![3](3.png)

+ Step 4: Start an HTTP listening service locally.

  ![4](4.png)

+ Step 5: Enter the target address to test for the SSRF vulnerability.

  ![5](5.png)

+ Step 6: The server receives the request (confirming the vulnerability is exploitable).
